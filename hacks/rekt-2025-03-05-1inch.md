...
excerpt: "One hacker transformed 1inch resolver contracts into a $5 million ATM through an integer underflow exploit - all with a negative 512 value. Attacker pocketed $450K as a 'bounty' for exposing two years"
genome:
  - "[[underflow]]"
  - "[[known-pattern]]"
  - "[[fot-slippage]]"
...
> **Loss:** $5,000,000 | **Date:** 2025-03-05 | **Audited by:** N/A
