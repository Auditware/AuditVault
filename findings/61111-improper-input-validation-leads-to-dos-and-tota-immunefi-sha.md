...
auditors:
  - "[[neplox]]"
report: "https://github.com/immunefi-team/Past-Audit-Competitions/blob/main/Shardeum%20Core/33278%20-%20%5BBC%20-%20Critical%5D%20Improper%20input%20validation%20leads%20to%20DOS%20and%20tota....md"
genome:
  - "[[frozen-funds]]"
  - "[[direct-drain]]"
  - "[[dos-resistance]]"
---
# Improper input validation leads to DOS and tota...

- id: 61111
- impact: HIGH
- protocol: [[Shardeum]]
- reporter: neplox (Immunefi)
- source: https://github.com/immunefi-team/Past-Audit-Competitions/blob/main/Shardeum%20Core/33278%20-%20%5BBC%20-%20Critical%5D%20Improper%20input%20validation%20leads%20to%20DOS%20and%20tota....md

## Summary


This report describes a bug in the Shardeum repository that can cause a complete shutdown of the network and result in loss of funds. The bug is found in the `eth_getBlockHashes` endpoint, which can be exploited by setting the `fromBlock` parameter to a very small number. This causes the validator nodes to go into an infinite loop, blocking the process and making the network unresponsive. The impact of this bug can be a total network shutdown or an attacker taking control of the network. A proof of concept was created to demonstrate the exploit and can be run on any network with a valid archiver URL. It is recommended to update the Shardeum repository to fix this vulnerability.
