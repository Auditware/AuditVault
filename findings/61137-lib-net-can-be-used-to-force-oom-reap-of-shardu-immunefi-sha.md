...
auditors:
  - "[[riproprip]]"
report: "https://github.com/immunefi-team/Past-Audit-Competitions/blob/main/Shardeum%20Core/34093%20-%20%5BBC%20-%20Critical%5D%20lib-net%20can%20be%20used%20to%20force%20oom%20reap%20of%20shardu....md"
genome:
  - "[[griefing]]"
  - "[[permanent]]"
  - "[[fot-slippage]]"
---
# lib-net can be used to force oom reap of shardu...

- id: 61137
- impact: HIGH
- protocol: [[Shardeum]]: Core
- reporter: riproprip (Immunefi)
- source: https://github.com/immunefi-team/Past-Audit-Competitions/blob/main/Shardeum%20Core/34093%20-%20%5BBC%20-%20Critical%5D%20lib-net%20can%20be%20used%20to%20force%20oom%20reap%20of%20shardu....md

## Summary


This bug report is about a vulnerability in the lib-net software that is used for blockchain and distributed ledger technology. The bug can be used to crash the shardus-instances, which can lead to network shutdown and affect projects with a high market capitalization. The vulnerability can also be used to crash other processes on the operating system. The report provides details about how the bug works and its impact on different systems. It also includes a proof of concept for the bug. The report recommends fixing the bug to prevent potential crashes and disruptions to the network. 
