...
auditors:
  - "[[Code4rena]]"
report: "https://code4rena.com/reports/2021-11-streaming"
genome:
  - "[[wrong-condition]]"
  - "[[specific-token-type]]"
  - "[[direct-drain]]"
...
- impact: HIGH
- protocol: [[Streaming Protocol]]
- reporter: Code4rena (Code4rena)
- source: https://code4rena.com/reports/2021-11-streaming

## Summary


The report highlights a bug in the `Streaming` contract which allows the deposit and reward tokens to be the same, potentially leading to issues when recovering tokens. This bug was discovered by multiple users and confirmed by the contract's creator. The report also includes a proof of concept and recommended mitigation steps to fix the bug.
