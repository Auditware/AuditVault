...
auditors:
  - "[[doxtopzhivago]]"
report: "https://github.com/immunefi-team/Past-Audit-Competitions/blob/main/Shardeum%20Core/33086%20-%20%5BBC%20-%20Critical%5D%20Complete%20shutdown%20of%20the%20transaction%20processing....md"
genome:
  - "[[griefing]]"
  - "[[temporary]]"
  - "[[insider]]"
...
- impact: HIGH
- protocol: [[Shardeum]]
- reporter: doxtopzhivago (Immunefi)
- source: https://github.com/immunefi-team/Past-Audit-Competitions/blob/main/Shardeum%20Core/33086%20-%20%5BBC%20-%20Critical%5D%20Complete%20shutdown%20of%20the%20transaction%20processing....md

## Summary


This bug report is about a problem in a blockchain or distributed ledger technology. The issue is with a specific code on a website and it can cause the network to shut down and not be able to confirm new transactions. The problem is related to a mechanism that is used to lock certain functions, which can cause delays or even stop the processing of transactions. By sending a large list of accounts, an attacker can overload this mechanism and slow down or stop the transaction processing on a single node or even the entire network. The report also includes a proof of concept, which shows how an attacker can exploit this vulnerability by sending a large number of random accounts to a specific node. This can cause the node to become offline and impact the whole network. The report suggests making changes to the code to fix this issue. 
